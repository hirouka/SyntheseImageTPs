#############################################################################
# Makefile for building: tp04
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. févr. 12 17:10:30 2019
# Project:  main.pro
# Template: app
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/tp041.0.0 || $(MKDIR) .tmp/tp041.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/tp041.0.0/ && $(COPY_FILE) --parents shader.h meshLoader.h trackball.h camera.h viewer.h .tmp/tp041.0.0/ && $(COPY_FILE) --parents shader.cpp meshLoader.cpp trackball.cpp camera.cpp main.cpp viewer.cpp .tmp/tp041.0.0/ && (cd `dirname .tmp/tp041.0.0` && $(TAR) tp041.0.0.tar tp041.0.0 && $(COMPRESS) tp041.0.0.tar) && $(MOVE) `dirname .tmp/tp041.0.0`/tp041.0.0.tar.gz . && $(DEL_FILE) -r .tmp/tp041.0.0
